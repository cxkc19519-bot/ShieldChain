...
**Inputs:** Phase 1 crypto, Phase 2 registrations, Phase 3 OTK/contact state; IV-E Steps 4–9 logical protocol; ACT lifecycle and failure semantics; ambiguity decisions 3, 5–8, 10–12, and 17. The detailed TDD plan must name the authorization snapshot/CAS API, handler-admission boundary, and no-crash versus crash assertions.
