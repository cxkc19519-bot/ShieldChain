...
> 文档状态：当前入口（更新于 2026-08-23）。本页与仓库当前代码、根目录 `README.md` 共同定义现行能力；历史计划和验收快照仅用于追溯。
...
- 安全运营报告智能体可直接使用事件、告警、漏洞、弱密码四类进程内只读工具；同一 Provider 已通过默认关闭的标准 MCP 2026-07-28 `/mcp` 适配器发布，完成鉴权前禁止生产启用；
